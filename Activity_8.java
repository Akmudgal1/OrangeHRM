...
public class Activity_8 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("applyleave_txtFromDate")).sendKeys("2022-05-17");
		driver.findElement(By.id("applyleave_txtToDate")).clear();
		driver.findElement(By.id("applyleave_txtToDate")).sendKeys("2022-05-17");

		driver.findElement(By.id("applyBtn")).click();
		// to check the applied leaves
		...
		driver.findElement(By.xpath("//input[@id='calFromDate']")).sendKeys("2022-05-17");
		driver.findElement(By.xpath("//input[@id='calToDate']")).clear();
		driver.findElement(By.xpath("//input[@id='calToDate']")).sendKeys("2022-05-17");
