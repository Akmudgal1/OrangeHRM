...
public class Activity_5 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='personal_txtEmpFirstName']")).sendKeys("Akanksha");
		driver.findElement(By.xpath("//input[@id='personal_txtEmpLastName']")).clear();
		driver.findElement(By.xpath("//input[@id='personal_txtEmpLastName']")).sendKeys("Mudgal");
		...
		driver.findElement(By.xpath("//input[@id='personal_DOB']")).sendKeys("1989-08-25");
		driver.findElement(By.xpath("//input[@id='btnSave']")).click();
		driver.close();
	}
